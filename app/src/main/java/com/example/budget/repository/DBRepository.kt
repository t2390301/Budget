...
class DBRepository(val db: DatabaseHelper) {
    companion object {
    ...
    private val planningNoteDao = db.getPlanningNoteDao()
    ...
    suspend fun getPlanningNotes(): List<PlanningNote> = planningNoteDao.getAll().map {
        it.toPlanningNote()
    }
